...
#define kDefaultDBName @"myDB.sqlite"

@interface PRDataBaseManager()

@property (nonatomic, copy) NSString *name;

@end

@implementation PRDataBaseManager

static PRDataBaseManager * _sharedDBManager;

+ (PRDataBaseManager *) defaultDBManager {
    if (!_sharedDBManager) {
        _sharedDBManager = [[PRDataBaseManager alloc] init];
    }
